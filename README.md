...
| **[Platform Engineering Systems (CD)](https://github.com/ibtisam-iq/platform-engineering-systems/tree/main/systems/java-monolith)** | Platform architecture (deploys, operates, and scales the artifact across multiple targets) |
...
| Vulnerability Scanning | Trivy (FS and Image scanning) |
| Artifact Registry | Sonatype Nexus (Snapshots) and AWS ECR |
...
| AWS Core Compute | EC2 Auto Scaling, Application Load Balancer (ALB) |
...
```text
systems/java-monolith/
├── ec2-asg/           # Architecture 1: EC2, ASG, ALB, RDS (Containerless)
├── ecs/               # Architecture 2: ECS Fargate, ECR
├── k8s/               # Architecture 3 and 4: Kubernetes manifests
│   ├── base/          # Core resources (Deployments, Services, ConfigMaps, PVCs)
